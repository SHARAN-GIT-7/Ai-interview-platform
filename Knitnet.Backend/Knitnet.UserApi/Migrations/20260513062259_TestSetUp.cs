        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    company_id = table.Column<Guid>(type: "uuid", nullable: false),
                    hr_id = table.Column<Guid>(type: "uuid", nullable: false),
                    TestInfoTestId = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_test_mappings", x => x.id);
                    table.ForeignKey(
                        name: "FK_test_mappings_test_infos_TestInfoTestId",
                        column: x => x.TestInfoTestId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_test_mappings_TestInfoTestId",
                table: "test_mappings",
                column: "TestInfoTestId");

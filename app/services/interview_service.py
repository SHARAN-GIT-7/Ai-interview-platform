...
def verify_interview(unique_id, webcam_image):
    ...
    # ==========================================
        ...
        if direction == "CENTER" and session.direction_counter["CENTER"] >= DIRECTION_STABLE_FRAMES:
            ...
            # First: Check for screen spoofing
            ...
            # If more than 40% frames show screen characteristics
            if screen_detected_count > len(session.frame_buffer) * 0.4:
                result = {
                    "status": "Verification Failed",
                    "reason": "Mobile screen or photo detected",
                    "error": True
                }
